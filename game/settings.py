...
TEXTS = {
    'VI': {
        ...
        'tut_content': [
            ...
            "- Ớt chuông có cơ chế gộp đặc biệt. Sau khi bạn chơi được đến",
            "ô 128, có khả năng sẽ xuất hiện ô ớt chuông, các ô ớt chuông",
            "không thể gộp với nhau nhưng có thể gộp với ô 256 rồi cả hai",
            "biến mất. Bạn sẽ có điểm thưởng.",
        ...
        'credit_content': [
            ...
            "Đặc biệt cảm ơn thầy Lê Đức Khoan",
            "12/2025"
        ]
    },
    'EN': {
        ...
        'tut_content': [
            ...
            "- Bell peppers have a special merging mechanic. After you reach the",
            "128 tile, there is a chance that a bell pepper tile will appear.",
            "Bell pepper tiles cannot merge with each other, but they can merge",
            "with a 256 tile, after which both tiles disappear and you receive a",
            "bonus score.",
