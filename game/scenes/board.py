...
class BoardScene:
    def __init__(self, app, env):
        ...
        # --- FONTS (Ưu tiên Shin Font theo yêu cầu) ---
        if os.path.exists(SHIN_FONT_PATH):
            ...
            # Fallback sang Arial nếu không tìm thấy file font
    ...
    def handle_popup_event(self, event):
        ...
        # Xử lý nhập tên file Save
        if self.popup_mode == 'SAVE':
            # Dùng TEXTINPUT để hỗ trợ gõ unicode tốt nhất có thể
    ...
    def draw_text_centered(self, text, y_off, size=24, color=(0,0,0)):
        # Nếu dùng Shin Font, tạo font từ file
        if os.path.exists(SHIN_FONT_PATH):
    ...
    def draw_btn_simple(self, text, pos, color, w=100, h=40):
        ...
        # Sử dụng self.popup_font đã được khởi tạo theo ưu tiên ở __init__
